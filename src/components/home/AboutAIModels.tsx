...
import { FaBrain, FaComments, FaEye, FaChartLine } from "react-icons/fa6";
    ...
    <section className={s.aboutSection}>
        ...
        <div className={s.aboutGrid}>
            <div className={s.featureCard}>
                <div className={s.featureIcon}><FaBrain /></div>
            ...
            <div className={s.featureCard}>
                <div className={s.featureIcon}><FaComments /></div>
            ...
            <div className={s.featureCard}>
                <div className={s.featureIcon}><FaEye /></div>
            ...
            <div className={s.featureCard}>
                <div className={s.featureIcon}><FaChartLine /></div>
