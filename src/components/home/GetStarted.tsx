...
import { AddIcon, SearchIcon, UserIcon, StarIcon } from "@src/assets/icons";
import { FaRocket } from "react-icons/fa6";

export const GetStarted = () => (
    <section className={s.getStartedSection}>
        <div className={s.getStartedContent}>
            <div className={s.sectionBadge} style={{ background: 'rgba(255, 255, 255, 0.2)', color: 'white' }}><FaRocket /> Start Your Journey</div>
            ...
            <div className={s.ctaButtons}>
                <Link to={AUTH}><button className={s.ctaPrimary}><FaRocket /> Create Free Account</button></Link>
